...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ...
      processing: true,
      pagination: 10,
      ajax: baseUrl + 'app/user/getusersdata',
      columns: [{ data: 'id' }, { data: 'username' }, { data: 'email' }, { data: 'phone' }, { data: 'action' }],
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return $email ? '<span class="fw-medium">' + $email + '</span>' : '';
          }
        },
        {
          // Phone
          ...
          render: function (data, type, full, meta) {
            ...
            return $phone ? '<span class="fw-medium">' + $phone + '</span>' : '';
          }
        },
        {
          // Actions
...
function deleteUser(userId) {
  Swal.fire({
    ...
    if (result.value) {
      $.ajax({
        url: '/app/user/userdelete/' + userId,
        type: 'POST',
        headers: {
